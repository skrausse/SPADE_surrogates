...
def spade(spiketrains, bin_size, winlen, min_spikes=2, min_occ=2,
          ...
          psr_param=None, output_format='patterns', ground_truth=None,
          **surr_kwargs):
    r"""
    ...
    if n_surr > 0:
        ...
        pv_spec = pvalue_spectrum(
            ...
            surr_method=surr_method, ground_truth=ground_truth,
            **surr_kwargs)
...
def _check_input(
    ...
    # Check surr_method
    if surr_method not in surr.SURR_METHODS and surr_method != 'ground_truth':
        raise ValueError(
...
def pvalue_spectrum(
        ...
        surr_method='dither_spikes', ground_truth=None, **surr_kwargs):
    """
